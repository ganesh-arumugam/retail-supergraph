...
echo "  • Dynatrace Distributed Traces (new Platform UI):"
echo "    https://\$DT_ENVIRONMENT_ID.apps.dynatrace.com/ui/apps/dynatrace.distributed-traces"
echo ""
echo "  • Dynatrace Metrics Explorer:"
echo "    https://\$DT_ENVIRONMENT_ID.apps.dynatrace.com/ui/apps/dynatrace.metrics"
echo ""
